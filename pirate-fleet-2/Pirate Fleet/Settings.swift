...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! It will strike one of your ships."
        static let ComputerHitMonster = "The computer has hit a sea monster! One of its ships will be struck."
